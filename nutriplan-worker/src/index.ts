...
${
	includeDessert
		? `INSTRUCCIÓN CRÍTICA: Asegúrate de que CADA UNO de los ${
				menuCount || 1
		  } menús devueltos INCLUYA un postre detallado en el campo "postre".`
		: `INSTRUCCIÓN CRÍTICA: Asegúrate de que el campo "postre" en CADA UNO de los menús sea null, ya que no se incluye postre.`
}
${menuCount > 1 ? 'Asegúrate de que el "nombre" del menú (ej: "Menú 1", "Menú 2", etc.) sea distinto.' : ''}
